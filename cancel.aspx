<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cancel.aspx.cs" Inherits="Hotel_Management_System.cancel" %>
                    ...
                    <div class="col-md-8 col-sm-6 col-xs-2">
                        <div class="main-menu">
                            <ul class="visible-lg visible-md">
                                ...
                                <li class="active"><a href="cancel.aspx">Cancel Booking</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-lg-4">
                            <div class="flex-caption visible-lg">
                                <h3 class="title">ITC Maurya<br />
                                    <i>
                                        <medium>Starts at</medium>
                                    </i></h3>
                                <span class="price">$ 80</span>
                                <br />
                                <br />
                                <p>
                                    ITC Maurya, a premier luxury hotel in Delhi
                                    <br />
                                    is named after the famous ‘Mauryan” dynasty....
                                </p>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-lg-4">
                            <div class="flex-caption visible-lg">
                                ...
                                <br />
                                <p>
                                    In an ambience steeped in history, complemented by a
                                    <br />
                                    richness of culture acquired through centuries....
                                </p>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-lg-4">
                            <div class="flex-caption visible-lg">
                                ...
                                <br />
                                <p>
                                    WelcomHotel Bella Vista offers
                                    <br />
                                    a spectacular view of the lofty Shivaliks ...
                                </p>
    ...
    <div class="site-footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="copyright">
                        <span>Copyright &copy; 2021 <a href="home.aspx">ITC Hotel</a> - <a href="home.aspx">Booking</a> by </span><a href="home.aspx">Alim Abdul</a>
                    </div>
                </div>
                <!-- /.col-md-4 -->
                <div class="col-md-4 col-sm-4">
